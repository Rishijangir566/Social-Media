...
//       await fetchFriendData(mainUser.uniqueId); // ✅ Re-enable this
//     } catch (err) {
//       console.error(err);
...
//         await fetchFriendData(userId); // ✅ Update friendData to reflect new request
//       }
//     } catch (error) {
...
//   const isRequestAlreadySent = (receiverId) => {
//     return friendData?.sentRequests?.some((req) => req._id === receiverId);
//   };
...
//                   disabled={isRequestAlreadySent(profileId)}
//                   className={`text-[15px] border py-1.5 px-5 rounded-2xl cursor-pointer ${
//                     isRequestAlreadySent(profileId)
//                       ? "opacity-50 cursor-not-allowed"
//                       : ""
//                   }`}
//                 >
//                   {isRequestAlreadySent(profileId) ? "Requested" : "Connect"}
//                 </button>
//               </div>
//             </div>
//           );
