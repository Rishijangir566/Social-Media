...
// import PostViewer from "./PostViwer.jsx";
...
//       formData.append("profilepic", profilepic);
//       formData.append("userName", userName);
//       formData.append("content", content); // ✅ HTML content from Editor
//       formData.append("hashtags", hashtags);
//       if (postImage) formData.append("postImage", postImage);
...
//                 type="text"
//                 placeholder="#trending #awesome #socialmedia"
//                 className="w-full p-6 bg-white/10 backdrop-blur-xl border-2 border-white/20 rounded-2xl text-white placeholder-white/50 pl-14"
//                 value={hashtags}
//                 onChange={(e) => setHashtags(e.target.value)}
//               />
//               <Hash className="absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-purple-400/60" />
